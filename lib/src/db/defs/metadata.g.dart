...
extension GetDbMetadataCollection on Isar {
  IsarCollection<DbMetadata> get metadata => this.collection();
}
...
extension DbMetadataQueryWhereSort
  ...
  QueryBuilder<DbMetadata, DbMetadata, QAfterWhere> anyId() {
...
extension DbMetadataQueryWhere
  ...
  QueryBuilder<DbMetadata, DbMetadata, QAfterWhereClause> idEqualTo(Id id) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DbMetadata, DbMetadata, QAfterWhereClause> idNotEqualTo(Id id) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DbMetadata, DbMetadata, QAfterWhereClause> idGreaterThan(Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DbMetadata, DbMetadata, QAfterWhereClause> idLessThan(Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<DbMetadata, DbMetadata, QAfterWhereClause> idBetween(
    Id lowerId,
    Id upperId, {
...
extension DbMetadataQueryFilter
  ...
  QueryBuilder<DbMetadata, DbMetadata, QAfterFilterCondition> dataEqualTo(
    String value, {
  ...
  QueryBuilder<DbMetadata, DbMetadata, QAfterFilterCondition> dataGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<DbMetadata, DbMetadata, QAfterFilterCondition> dataLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<DbMetadata, DbMetadata, QAfterFilterCondition> dataBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<DbMetadata, DbMetadata, QAfterFilterCondition> dataStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DbMetadata, DbMetadata, QAfterFilterCondition> dataEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DbMetadata, DbMetadata, QAfterFilterCondition> dataContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DbMetadata, DbMetadata, QAfterFilterCondition> dataMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DbMetadata, DbMetadata, QAfterFilterCondition> dataIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'data',
        value: '',
  ...
  QueryBuilder<DbMetadata, DbMetadata, QAfterFilterCondition> dataIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'data',
        value: '',
...
extension DbMetadataQuerySortBy
  ...
  QueryBuilder<DbMetadata, DbMetadata, QAfterSortBy> sortByData() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'data', Sort.asc);
    });
  }

  QueryBuilder<DbMetadata, DbMetadata, QAfterSortBy> sortByDataDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension DbMetadataQuerySortThenBy
  ...
  QueryBuilder<DbMetadata, DbMetadata, QAfterSortBy> thenByData() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'data', Sort.asc);
    });
  }

  QueryBuilder<DbMetadata, DbMetadata, QAfterSortBy> thenByDataDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'data', Sort.desc);
    });
  }
...
extension DbMetadataQueryWhereDistinct
  ...
  QueryBuilder<DbMetadata, DbMetadata, QDistinct> distinctByData(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension DbMetadataQueryProperty
  ...
  QueryBuilder<DbMetadata, int, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'id');
    });
  }

  QueryBuilder<DbMetadata, String, QQueryOperations> dataProperty() {
    return QueryBuilder.apply(this, (query) {
